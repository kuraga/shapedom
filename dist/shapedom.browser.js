(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Shapedom = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"an-uuid":2,"babel-runtime/core-js/get-iterator":3,"babel-runtime/core-js/object/assign":4,"babel-runtime/core-js/object/get-prototype-of":7,"babel-runtime/core-js/object/keys":8,"babel-runtime/core-js/weak-map":12,"babel-runtime/helpers/classCallCheck":13,"babel-runtime/helpers/createClass":14,"babel-runtime/helpers/inherits":15,"babel-runtime/helpers/possibleConstructorReturn":16}],2:[function(require,module,exports){
var t =
...
},{"core-js/library/fn/object/define-property":21}],7:[function(require,module,exports){
...
},{"core-js/library/fn/weak-map":27}],13:[function(require,module,exports){
"use strict";
...
},{"../core-js/object/create":5,"../core-js/object/set-prototype-of":9,"../helpers/typeof":17}],16:[function(require,module,exports){
"use strict";
...
},{"../modules/core.get-iterator":78,"../modules/es6.string.iterator":85,"../modules/web.dom.iterable":88}],19:[function(require,module,exports){
require('../../modules/es6.object.assign');
module.exports = require('../../modules/$.core').Object.assign;
},{"../../modules/$.core":37,"../../modules/es6.object.assign":80}],20:[function(require,module,exports){
var $ = require('../../modules/$');
...
},{"../../modules/$":58}],22:[function(require,module,exports){
require('../../modules/es6.object.get-prototype-of');
module.exports = require('../../modules/$.core').Object.getPrototypeOf;
},{"../../modules/$.core":37,"../../modules/es6.object.get-prototype-of":81}],23:[function(require,module,exports){
require('../../modules/es6.object.keys');
module.exports = require('../../modules/$.core').Object.keys;
},{"../../modules/$.core":37,"../../modules/es6.object.keys":82}],24:[function(require,module,exports){
require('../../modules/es6.object.set-prototype-of');
module.exports = require('../../modules/$.core').Object.setPrototypeOf;
},{"../../modules/$.core":37,"../../modules/es6.object.set-prototype-of":83}],25:[function(require,module,exports){
require('../../modules/es6.symbol');
require('../../modules/es6.object.to-string');
module.exports = require('../../modules/$.core').Symbol;
},{"../../modules/$.core":37,"../../modules/es6.object.to-string":84,"../../modules/es6.symbol":86}],26:[function(require,module,exports){
require('../../modules/es6.string.iterator');
require('../../modules/web.dom.iterable');
module.exports = require('../../modules/$.wks')('iterator');
},{"../../modules/$.wks":76,"../../modules/es6.string.iterator":85,"../../modules/web.dom.iterable":88}],27:[function(require,module,exports){
require('../modules/es6.object.to-string');
require('../modules/web.dom.iterable');
require('../modules/es6.weak-map');
module.exports = require('../modules/$.core').WeakMap;
},{"../modules/$.core":37,"../modules/es6.object.to-string":84,"../modules/es6.weak-map":87,"../modules/web.dom.iterable":88}],28:[function(require,module,exports){
...
},{"./$.is-object":52}],31:[function(require,module,exports){
// 0 -> Array#forEach
// 1 -> Array#map
// 2 -> Array#filter
// 3 -> Array#some
...
},{"./$.array-species-create":32,"./$.ctx":38,"./$.iobject":49,"./$.to-length":73,"./$.to-object":74}],32:[function(require,module,exports){
...
},{"./$.is-array":51,"./$.is-object":52,"./$.wks":76}],33:[function(require,module,exports){
...
},{"./$.cof":34,"./$.wks":76}],34:[function(require,module,exports){
...
},{"./$.an-object":30,"./$.array-methods":31,"./$.for-of":44,"./$.has":47,"./$.hide":48,"./$.is-object":52,"./$.redefine-all":64,"./$.strict-new":69,"./$.uid":75}],36:[function(require,module,exports){
'use strict';
var $              = require('./$')
...
},{"./$":58,"./$.descriptors":40,"./$.export":42,"./$.fails":43,"./$.for-of":44,"./$.global":46,"./$.hide":48,"./$.is-object":52,"./$.redefine-all":64,"./$.set-to-string-tag":67,"./$.strict-new":69}],37:[function(require,module,exports){
...
},{"./$.a-function":28}],39:[function(require,module,exports){
...
},{"./$.fails":43}],41:[function(require,module,exports){
...
},{"./$.core":37,"./$.ctx":38,"./$.global":46}],43:[function(require,module,exports){
...
},{"./$.an-object":30,"./$.ctx":38,"./$.is-array-iter":50,"./$.iter-call":53,"./$.to-length":73,"./core.get-iterator-method":77}],45:[function(require,module,exports){
...
},{"./$":58,"./$.to-iobject":72}],46:[function(require,module,exports){
...
},{"./$":58,"./$.descriptors":40,"./$.property-desc":63}],49:[function(require,module,exports){
// fallback for non-array-like ES3 and non-enumerable old V8 strings
var cof = require('./$.cof');
module.exports = Object('z').propertyIsEnumerable(0) ? Object : function(it){
  return cof(it) == 'String' ? it.split('') : Object(it);
};
},{"./$.cof":34}],50:[function(require,module,exports){
...
},{"./$.cof":34}],52:[function(require,module,exports){
module.exports = function(it){
...
},{"./$.an-object":30}],54:[function(require,module,exports){
'use strict';
var $              = require('./$')
...
},{"./$":58,"./$.hide":48,"./$.property-desc":63,"./$.set-to-string-tag":67,"./$.wks":76}],55:[function(require,module,exports){
'use strict';
...
},{"./$":58,"./$.export":42,"./$.has":47,"./$.hide":48,"./$.iter-create":54,"./$.iterators":57,"./$.library":60,"./$.redefine":65,"./$.set-to-string-tag":67,"./$.wks":76}],56:[function(require,module,exports){
...
},{"./$":58,"./$.to-iobject":72}],60:[function(require,module,exports){
module.exports = true;
...
},{"./$":58,"./$.fails":43,"./$.iobject":49,"./$.to-object":74}],62:[function(require,module,exports){
...
},{"./$.core":37,"./$.export":42,"./$.fails":43}],63:[function(require,module,exports){
...
},{"./$.hide":48}],66:[function(require,module,exports){
...
},{"./$":58,"./$.an-object":30,"./$.ctx":38,"./$.is-object":52}],67:[function(require,module,exports){
...
},{"./$.defined":39,"./$.to-integer":71}],71:[function(require,module,exports){
// 7.1.4 ToInteger
var ceil  = Math.ceil
  , floor = Math.floor;
module.exports = function(it){
...
},{"./$.defined":39,"./$.iobject":49}],73:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./$.to-integer')
  , min       = Math.min;
module.exports = function(it){
...
},{"./$.defined":39}],75:[function(require,module,exports){
var id = 0
  , px = Math.random();
module.exports = function(key){
...
},{"./$.classof":33,"./$.core":37,"./$.iterators":57,"./$.wks":76}],78:[function(require,module,exports){
var anObject = require('./$.an-object')
...
},{"./$.an-object":30,"./$.core":37,"./core.get-iterator-method":77}],79:[function(require,module,exports){
'use strict';
...
},{"./$.add-to-unscopables":29,"./$.iter-define":55,"./$.iter-step":56,"./$.iterators":57,"./$.to-iobject":72}],80:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $export = require('./$.export');

$export($export.S + $export.F, 'Object', {assign: require('./$.object-assign')});
},{"./$.export":42,"./$.object-assign":61}],81:[function(require,module,exports){
...
},{"./$.object-sap":62,"./$.to-object":74}],82:[function(require,module,exports){
...
},{"./$.object-sap":62,"./$.to-object":74}],83:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $export = require('./$.export');
$export($export.S, 'Object', {setPrototypeOf: require('./$.set-proto').set});
},{"./$.export":42,"./$.set-proto":66}],84:[function(require,module,exports){
...
},{"./$.iter-define":55,"./$.string-at":70}],86:[function(require,module,exports){
'use strict';
...
},{"./$":58,"./$.an-object":30,"./$.descriptors":40,"./$.enum-keys":41,"./$.export":42,"./$.fails":43,"./$.get-names":45,"./$.global":46,"./$.has":47,"./$.is-array":51,"./$.keyof":59,"./$.library":60,"./$.property-desc":63,"./$.redefine":65,"./$.set-to-string-tag":67,"./$.shared":68,"./$.to-iobject":72,"./$.uid":75,"./$.wks":76}],87:[function(require,module,exports){
'use strict';
var $            = require('./$')
  , redefine     = require('./$.redefine')
...
},{"./$":58,"./$.collection":36,"./$.collection-weak":35,"./$.has":47,"./$.is-object":52,"./$.redefine":65}],88:[function(require,module,exports){
require('./es6.array.iterator');
var Iterators = require('./$.iterators');
Iterators.NodeList = Iterators.HTMLCollection = Iterators.Array;
},{"./$.iterators":57,"./es6.array.iterator":79}]},{},[1])(1)
});